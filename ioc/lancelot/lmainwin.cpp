...
| Set the application's focus and show it                                     |
 ----------------------------------------------------------------------------*/
   ...
   infoarea.setDefaultText( ID_MAIN_OFFSET_INFOAREA+ID_MAIN );
...
*   menu items.                                                               *
******************************************************************************/
LMainWindow& LMainWindow::enableSelects( bool which )
{
...
******************************************************************************/
bool LMainCnr::makePopUpMenu( IMenuEvent& evt )
{
   bool
      retCode = true,
      hasSelectItem = true;
...
-----------------------------------------------------------------------------*/
      popm =
         new IPopUpMenu ( whichMenu, evt.controlWindow() );
      if ( hasSelectItem &&
...
******************************************************************************/
bool LMainCnr::enter( ICnrEnterEvent& evt )
{
   bool
      retCode = false;
...
******************************************************************************/
bool LMainCnr::help( ICnrHelpEvent& evt )
{
   delete helpWin;
...
*   toolbar buttons.                                                          *
******************************************************************************/
LMainToolBar& LMainToolBar::enableSelects( bool which )
{
...
******************************************************************************/
bool LMainWindowCommandHandler::command( ICommandEvent& evt )
{
   bool
...
******************************************************************************/
bool LMainWindowCommandHandler::deleteAction( LMainCnrObject* pObject )
{
   bool
      retCode = false;
...
******************************************************************************/
bool LMainWindowHelpHandler::keysHelpId( IEvent& evt )
{
