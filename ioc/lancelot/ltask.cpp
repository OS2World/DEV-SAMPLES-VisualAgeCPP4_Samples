...
******************************************************************************/
bool TasksPage::verifyAndSave( IString& theString,
                                         IString& theEntry,
...
******************************************************************************/
bool TasksPage::command( ICommandEvent& cmdEvent )
{
   IString
      theTask = task.text(),
      theDesc = descr.text(),
...
******************************************************************************/
bool TasksPage::addTask( IString& theTask, IString& theDesc,
                                   IString& theBill )
{
   bool
      rc = true;
...
******************************************************************************/
bool TasksPage::changeTask( IString& theTask, IString& theDesc,
                                     IString& theBill,
                                     TaskCnrObj* pCnrObj )
{
   bool
