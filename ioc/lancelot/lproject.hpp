...
-----------------------------------------------------------------------------*/
      ...
      inline unsigned long
         projOffset() { return ICONTAINERCOLUMN_OFFSETOF( ProjCnrObj, Proj ); };
      inline unsigned long
         descOffset() { return ICONTAINERCOLUMN_OFFSETOF( ProjCnrObj, Desc ); };
      inline unsigned long
         mgrOffset()  { return ICONTAINERCOLUMN_OFFSETOF( ProjCnrObj, Mgr ); };
      inline unsigned long
         actOffset()  { return ICONTAINERCOLUMN_OFFSETOF( ProjCnrObj, Act ); };
