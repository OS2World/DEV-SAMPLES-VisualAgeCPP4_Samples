...
******************************************************************************/
bool LInfoNotebook::verifyPages( IString queryName )
{
   bool
      retCode = true;
   IString
...
******************************************************************************/
bool LInfoNotebook::command( ICommandEvent& event )
{
...
******************************************************************************/
bool LInfoNotebook::select( IPageSelectEvent& pageevt )
{
   IPageHandle
      testPage;
   IString
