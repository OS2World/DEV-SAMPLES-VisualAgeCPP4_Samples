...
// -------------------------------------------------------------------------
bool QueryEmpl :: getId( IString& item1)
{
...
// -------------------------------------------------------------------------
bool QueryEmpl :: putId( const IString& item1)
{
...
// -------------------------------------------------------------------------
bool QueryInfo :: getSearchItem( IString& field
                                            , IString& data
                                            , IString& range)
{
   bool retCode=false;
...
// -------------------------------------------------------------------------
bool  QueryInfo :: getMatchId(IString& theID )
{
...
// -------------------------------------------------------------------------
bool QueryInfo :: inRange(const IString &c1
                                     ,const IString &c2
                                     ,const IString &range)
{
...
// -------------------------------------------------------------------------
bool QueryInfo :: compareIt( const ADate* d1,
                                         const ADate* d2,
                                         const IString& range)
{
   bool retCode = false;
...
// -------------------------------------------------------------------------
bool QueryInfo :: compareIt( const long  d1
                                        ,const long  d2
                                        ,const IString& range)
{
   bool retCode = false;
...
// -------------------------------------------------------------------------
bool  QueryGenl :: aMatch(const LEmployeeData* ed,
                                      const IString& key,
                                      const IString& value)
{
  if (key == "employeeNum" )
...
// -------------------------------------------------------------------------
bool  QueryMgrs :: aMatch(const LEmployeeData* ed,
                                      const IString& key,
                                      const IString& value)
{
...
// -------------------------------------------------------------------------
bool  QueryAcct :: aMatch(LAcctData* ed,
...
// QuerySkill :: aMatch()
// -------------------------------------------------------------------------
bool  QuerySkill :: aMatch(LSkillData* ed
...
// QueryBadge :: aMatch()
// -------------------------------------------------------------------------
bool  QueryBadge :: aMatch(LBadgeData* bd,
                                       const IString& key,
                                       const IString& value,
                                       const IString& range)
{
...
// QueryStatus :: aMatch()
// -------------------------------------------------------------------------
bool  QueryStatus :: aMatch(LStatusData* sd
                                       , const IString& key
                                       , const IString& value
                                       , const IString& range)
{
...
// QueryQry :: putQry()
// -------------------------------------------------------------------------
bool QueryQry :: putQry( const IString& item1)
{
   items.add(Item(item1));
...
// -------------------------------------------------------------------------
bool  QueryIntersection :: emptyBagIntersection()  {
 items.removeAll();
 itemsCur.invalidate();
 return (true);
};
...
// -------------------------------------------------------------------------
bool QueryIntersection :: putId( const IString& item1)
{
   items.add(item1);
