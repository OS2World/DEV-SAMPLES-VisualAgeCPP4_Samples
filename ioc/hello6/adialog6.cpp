...
{
/*----------------------------- Set Up Frame -----------------------------|
|  Since the entry field is now a combox box, load the box with items     |
...
|------------------------------------------------------------------------*/
  ...
  clientCanvas.setRowHeight(7ul, 10ul, true);

/*-------------------------- Set Up Frame Window -------------------------|
|  Set the multicell canvas as the ATextDialog client window.             |
|  Size the frame to fit the client.                                      |
...
|------------------------------------------------------------------------*/
  ...
  dialogPosition.centerAt( IWindow::desktopWindow()->rect().centerXCenterY() );
