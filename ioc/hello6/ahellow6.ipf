...
:h3 res=201.C++ Hello World - Dialog Combination Box Help
:p.This is the help panel for the combination box in the text dialog.
:p.
The combination box is defined as textField in adialog6.hpp and
is initialized and handled by code found in adialog6.cpp.
:p.
...
window.
:p.
The OK push button is defined as pushButton1 in adialog6.hpp and
is initialized and handled by code found in adialog6.cpp.
:p.
...
"Hello, World!!!" text.
:p.
The Cancel push button is defined as pushButton2 in adialog6.hpp and
is initialized and handled by code found in adialog6.cpp.
:p.
