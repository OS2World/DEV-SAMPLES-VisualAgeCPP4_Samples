...
// --------------------------------------------------------------------------------------------
IBase::Boolean LSkillData :: getItem( IString& item1
                                    ,IString& item2
                                    ,Rule& rule
                                    , Boolean useKey)
{
...
// --------------------------------------------------------------------------------------------
IBase::Boolean LSkillData :: putItem( const IString& item1
                                    ,const IString& item2
                                    ,const Rule& rule)
{
...
// --------------------------------------------------------------------------------------------
IBase::Boolean LAcctData :: getItem( IString& item1
                                   ,IString& item2
                                   , Rule& rule
                                   , Boolean useKey)
{
...
// --------------------------------------------------------------------------------------------
IBase:: Boolean LTaskData :: getItem( IString& item1
                                    ,IString& item2
                                    ,IString& item3
                                    ,Rule& rule)
{
...
// --------------------------------------------------------------------------------------------
IBase::Boolean LTaskData :: putItem( const IString& item1,
                                    const IString& item2,
                                    const IString& item3,
                                    const Rule& rule )
{
...
// --------------------------------------------------------------------------------------------
IBase :: Boolean  LTaskData :: isInAndBillable( const IString& empNum,
...
// --------------------------------------------------------------------------------------------
IBase::Boolean  LProjectData :: getItem( IString& item1,
                                        IString& item2,
                                        IString& item3,
                                        IString& item4,
                                        Rule rule)
...
// --------------------------------------------------------------------------------------------
IBase::Boolean LQueryData :: saveIni(const IString queryName)
{
   Boolean
      rv = true;
   try
   {
     ...
     // concat to make ultiple entries unique
...
// --------------------------------------------------------------------------------------------
IBase :: Boolean LQueryData :: getItem( IString& item2
                                      ,IString& item3
                                      ,IString& item4)
{
   // get a query
...
// --------------------------------------------------------------------------------------------
IBase :: Boolean LQueryData :: setFirstWithKey(char*  key)
{
...
// --------------------------------------------------------------------------------------------
IBase :: Boolean LQueryData :: getNextWithKey(char*  key)
{
  Entry aKey = Entry(key);
