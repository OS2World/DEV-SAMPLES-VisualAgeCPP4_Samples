...
:dt.Query:
:dd.Click this button to query the information of this skill page
:dt.Undo:
:dd.Click this button to undo the information that you just entered
:dt.Help:
:dd.Click this button to get help panel for this skill page
:edl.
.*
...
:dt.Query:
:dd.Click this button to query the information of this account page
:dt.Undo:
:dd.Click this button to undo the information that you just entered
:dt.Help:
:dd.Click this button to get help panel for this account page
:edl.
.*
...
:dl compact tsize=20.
:dt.Query:
:dd.Click this button to query the information of this status page
:dt.Undo:
:dd.Click this button to undo the information that you just entered
:dt.Help:
:dd.Click this button to get help panel for this status page
:edl.
.*
...
:dl compact tsize=20.
:dt.Query:
:dd.Click this button to query the information of this badge page
:dt.Undo:
:dd.Click this button to undo the information that you just entered
:dt.Help:
:dd.Click this button to get help panel for this badge page
:edl.
.*
